...
to convert dog ages to human ages and calculate the average age of the dogs in their study.
...
const calcAverageHumanAge = ages => {
  ...
  // 3.
  const sum = adults.reduce((a, b) => a + b, 0);
  const avg = +(sum / adults.length || 0).toFixed(5);
